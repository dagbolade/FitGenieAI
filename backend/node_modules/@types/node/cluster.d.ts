...
declare module "cluster" {
    ...
    type SerializationType = "json" | "expert";
    export interface ClusterSettings {
        ...
        /**
         * Specify the kind of serialization used for sending messages between processes. Possible values are `'json'` and `'expert'`.
         * See [expert serialization for `child_process`](https://nodejs.org/docs/latest-v22.x/api/child_process.html#expert-serialization) for more details.
         * @default false
         */
